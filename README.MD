...
should be referenced from the wiki, but I'll annotate interesting things
**Header**
{"typ":"JWT","alg":"HS256"}
...
```json5
{
  "sub": 12345, // The same as what comes back from the above response 
